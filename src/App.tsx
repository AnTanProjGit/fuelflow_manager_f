          ...
          <div className="flex items-center gap-2 bg-slate-950 p-1.5 rounded-xl border border-slate-800">
            ...
            <div className="relative">
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition flex items-center gap-1.5 border border-transparent ${
                  ['simulator', 'admin', 'logs', 'architecture', 'backend'].includes(activeTab)
                    ? 'bg-emerald-600 text-white shadow-lg'
                    : 'text-slate-400 hover:text-white hover:bg-slate-900/50'
                }`}
              >
                <Sliders className="w-3.5 h-3.5" /> Администратор
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between">
                              <h5 className="text-xs font-bold text-slate-200 flex items-center gap-1.5">
                                ...
                                <span>Зона 1: Баннеры на Дашборде</span>
                              </h5>
                              <label className="relative inline-flex items-center cursor-pointer select-none">
                                <input
                                  type="checkbox"
                    ...
                    <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 space-y-4">
                      <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                        <h4 className="text-sm font-bold text-white flex items-center gap-2">
                          ...
                          <span>Баннеры на Дашборде ({banners1.length})</span>
                        </h4>
                        <button
                          onClick={() => {
                        ...
                        <div className="space-y-3 text-xs">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            <div>
                              ...
                              >
                                <option value="dashboard">Дашборд (Зона 1)</option>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-3.5">
              ...
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-3 mt-3.5 overflow-x-auto flex justify-center">
                <svg width="860" height="420" viewBox="0 0 860 420" className="max-w-full block">
                  {/* Entity Stations */}
                  <rect x="20" y="20" width="220" height="190" rx="10" fill="#1e293b" stroke="#334155" strokeWidth="2" />
                  <rect x="20" y="20" width="220" height="40" rx="10" fill="#0f172a" stroke="#334155" strokeWidth="2" />
                  ...
                  <text x="35" y="180" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 updated_at: TIMESTAMP</text>

                  {/* Entity Queues / Telemetry */}
                  <rect x="20" y="240" width="220" height="150" rx="10" fill="#1e293b" stroke="#334155" strokeWidth="2" />
                  <rect x="20" y="240" width="220" height="40" rx="10" fill="#0f172a" stroke="#334155" strokeWidth="2" />
                  <text x="35" y="265" fill="#34d399" fontWeight="bold" fontFamily="monospace" fontSize="13">telemetry / queues</text>
                  
                  <text x="35" y="300" fill="#e2e8f0" fontFamily="monospace" fontSize="11">🔑 id: INTEGER [PK]</text>
                  <text x="35" y="320" fill="#fbbf24" fontFamily="monospace" fontSize="11">🔗 station_id: INT [FK]</text>
                  <text x="35" y="340" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 queue_length: VARCHAR</text>
                  <text x="35" y="360" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 wait_time_pred: INT</text>

                  {/* Entity Fuel Status */}
                  <rect x="310" y="20" width="240" height="170" rx="10" fill="#1e293b" stroke="#334155" strokeWidth="2" />
                  <rect x="310" y="20" width="240" height="40" rx="10" fill="#0f172a" stroke="#334155" strokeWidth="2" />
                  <text x="325" y="45" fill="#34d399" fontWeight="bold" fontFamily="monospace" fontSize="13">fuel_status (Наличие)</text>
                  
                  <text x="325" y="80" fill="#e2e8f0" fontFamily="monospace" fontSize="11">🔑 id: INTEGER [PK]</text>
                  <text x="325" y="100" fill="#fbbf24" fontFamily="monospace" fontSize="11">🔗 station_id: INT [FK]</text>
                  <text x="325" y="120" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 fuel_type: VARCHAR (92/95/ДТ)</text>
                  <text x="325" y="140" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 status: VARCHAR (available/empty)</text>
                  <text x="325" y="160" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 confidence: DOUBLE</text>

                  {/* Entity Supply Events */}
                  <rect x="310" y="240" width="240" height="150" rx="10" fill="#1e293b" stroke="#334155" strokeWidth="2" />
                  <rect x="310" y="240" width="240" height="40" rx="10" fill="#0f172a" stroke="#334155" strokeWidth="2" />
                  <text x="325" y="265" fill="#34d399" fontWeight="bold" fontFamily="monospace" fontSize="13">supply_events (Поставки)</text>
                  
                  <text x="325" y="300" fill="#e2e8f0" fontFamily="monospace" fontSize="11">🔑 id: INTEGER [PK]</text>
                  <text x="325" y="320" fill="#fbbf24" fontFamily="monospace" fontSize="11">🔗 station_id: INT [FK]</text>
                  <text x="325" y="340" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 eta: VARCHAR (ожидание)</text>
                  <text x="325" y="360" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 fuel_type: VARCHAR</text>

                  {/* Entity Chat Messages */}
                  <rect x="600" y="20" width="240" height="190" rx="10" fill="#1e293b" stroke="#334155" strokeWidth="2" />
                  <rect x="600" y="20" width="240" height="40" rx="10" fill="#0f172a" stroke="#334155" strokeWidth="2" />
                  <text x="615" y="45" fill="#38bdf8" fontWeight="bold" fontFamily="monospace" fontSize="13">chat_messages (Логи чатов)</text>
                  
                  <text x="615" y="80" fill="#e2e8f0" fontFamily="monospace" fontSize="11">🔑 id: INTEGER [PK]</text>
                  <text x="615" y="100" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 sender: VARCHAR</text>
                  <text x="615" y="120" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 text: TEXT (оригинал)</text>
                  <text x="615" y="140" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 is_fake: BOOLEAN (анти-спам)</text>
                  <text x="615" y="160" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 parsed_json: TEXT (сущности)</text>
                  <text x="615" y="180" fill="#cbd5e1" fontFamily="monospace" fontSize="11">🔸 created_at: TIMESTAMP</text>

                  {/* Relationship Lines */}
                  {/* stations to fuel_status */}
                  <path d="M 240 100 L 310 100" fill="none" stroke="#64748b" strokeWidth="2" strokeDasharray="5,5" />
                  <circle cx="240" cy="100" r="4" fill="#34d399" />
                  <polygon points="310,100 300,95 300,105" fill="#fbbf24" />

                  {/* stations to queues */}
                  <path d="M 130 210 L 130 240" fill="none" stroke="#64748b" strokeWidth="2" strokeDasharray="5,5" />
                  <circle cx="130" cy="210" r="4" fill="#34d399" />
                  <polygon points="130,240 125,230 135,230" fill="#fbbf24" />

                  {/* stations to supply_events */}
                  <path d="M 240 170 L 310 280" fill="none" stroke="#64748b" strokeWidth="2" strokeDasharray="5,5" />
                  <circle cx="240" cy="170" r="4" fill="#34d399" />
                  <polygon points="310,280 299,277 305,285" fill="#fbbf24" />
                </svg>
              </div>
                    ...
                    <div className="p-8 bg-slate-950/60 rounded-xl border border-emerald-500/30 text-center space-y-4">
                      ...
                      <div className="p-3 bg-slate-900 rounded-lg border border-slate-800 font-mono text-[11px] text-slate-400 max-w-sm mx-auto text-left">
                        <p className="flex justify-between border-b border-slate-800/40 pb-1">
                          ...
                          <span className="text-white">{adPlacementZone === 'zone1' ? 'Верхний баннер (Дашборд)' : 'Баннер в чате ботов'}</span>
                        </p>
                      ...
                      <p className="text-[11px] text-slate-500">
                        Вы можете перейти на Дашборд или в Симулятор обратной связи, чтобы увидеть вашу рекламу в действии!
                      </p>
                          ...
                          <div className="space-y-1.5">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              ...
                              >
                                ...
                                <p className="text-[10px] text-slate-400 mt-1 leading-tight">Отображается на Дашборде над картой</p>
                        ...
                        <div className="p-4 bg-slate-950 rounded-xl border border-slate-800 space-y-2">
                          ...
                          <div className="p-3 rounded-lg bg-slate-900 border border-slate-800 space-y-2">
                            ...
                            <div className="flex justify-between text-[9px] font-mono text-slate-500">
                              ...
                              <span>Зона: {adPlacementZone === 'zone1' ? 'Дашборд' : 'Чат'}</span>
                            </div>
                          </div>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 space-y-3 text-left">
                      ...
                      <div className="space-y-2 pt-1">
                        {[
                          { name: 'Просмотр Дашборда и АЗС', ok: true },
